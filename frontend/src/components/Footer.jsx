...
export default function Footer() {
  return (
    <footer className="bg-ink text-white">
      ...
      <div className="container-bank pt-16 md:pt-24 pb-12">
        <div className="grid grid-cols-12 gap-10 md:gap-14">
          <div className="col-span-12 md:col-span-3">
            ...
            <p className="mt-8 text-[14px] text-white/65 leading-relaxed max-w-xs">
              A modern African financial platform. Banking, markets, advisory.
            </p>
            <p className="mt-8 eyebrow eyebrow-on-dark mb-3">Open an account</p>
            <Link to="/personal" className="btn btn-primary text-[13.5px] py-2.5 px-4">
              Get started
            </Link>
          </div>
          ...
          {COLUMNS.map((col) => (
            <div key={col.title} className="col-span-6 md:col-span-2 lg:col-span-2">
              <p className="font-display text-[16px] text-white mb-5">{col.title}</p>
              <ul className="space-y-3">
                {col.links.map((l) => (
                  <li key={l.to}>
                    <Link
                      to={l.to}
                      className="text-[13.5px] text-white/70 hover:text-white hover-line"
                    >
                      {l.label}
                    </Link>
                  </li>
      ...
      <div className="container-bank py-10">
        <div className="grid grid-cols-12 gap-8">
          <div className="col-span-12 md:col-span-3">
            ...
            <p className="font-display text-[20px] text-white">Offices and desks</p>
          </div>
          {LOCATIONS.map((loc) => (
      ...
      {/* ─── Regulatory + © ─── */}
      <div className="container-bank py-8">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6 text-[12px] text-white/55">
          <div className="flex flex-wrap items-center gap-x-6 gap-y-2">
            ...
            <Link to="/regulatory" className="hover-line hover:text-white">Regulatory information</Link>
        ...
        <p className="mt-6 text-[11.5px] text-white/40 leading-relaxed max-w-4xl">
